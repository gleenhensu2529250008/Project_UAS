    ...
    @if(request('search'))
        <div class="mb-4">
            <div class="d-flex justify-content-between align-items-center">
                <h2 class="fw-bold text-white border-start border-4 border-pink ps-3 mb-0">
                    Hasil Pencarian: "{{ $correctedSearch ?? request('search') }}"
                </h2>
                <div class="d-flex gap-2">
                    ...
                    @endif
                    <a href="{{ route('anime.index') }}" class="btn btn-outline-light btn-sm py-2 px-3 fw-bold">
                        Reset
                    </a>
                </div>
            </div>
            @if(isset($originalSearch) && isset($correctedSearch) && strtolower($originalSearch) !== strtolower($correctedSearch))
                <div class="text-secondary small mt-2 ps-3">
                    Mencari kata kunci: <span class="text-decoration-line-through text-danger">{{ $originalSearch }}</span>. Menampilkan hasil terdekat (auto-correct).
                </div>
            @endif
        </div>
        ...
        <div class="row g-4 row-cols-1 row-cols-sm-2 row-cols-md-3 row-cols-lg-4 row-cols-xl-5">
            ...
            <div class="col-12 text-center py-5">
                <h4 class="text-secondary">Tidak ada anime yang cocok dengan pencarian Anda.</h4>
            </div>
            @endforelse
        </div>
    @else
        ...
        <!-- Horizontal scrollable list (Top Trending) -->
        <div class="anime-horizontal-scroll py-2 mb-5">
            <div class="d-flex flex-nowrap gap-4 overflow-auto pb-3" style="scrollbar-width: thin; scrollbar-color: #ff1493 #1a1a1a;">
