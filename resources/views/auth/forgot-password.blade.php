...
<head>
  ...
  <title>Reset Password — Anime Portal</title>
...
<div id="scene">
  <div class="card">
    ...
    <div class="logo-wrap">
      ...
      <div class="logo-sub">Reset Password Link</div>
    </div>

    @if (session('status'))
      <div class="alert alert-success py-2 px-3 mb-3" style="border-radius: 10px; font-size: 14px; background: rgba(46, 204, 113, 0.2); border: 1px solid #2ecc71; color: #fff; text-align: center;">
          {{ session('status') }}
      </div>
    @endif
    ...
    <form action="/forgot-password" method="POST">
      ...
      <div class="register-row">
        Kembali ke <a href="/login">Halaman Login</a>
      </div>
    </form>
  </div>
</div>
